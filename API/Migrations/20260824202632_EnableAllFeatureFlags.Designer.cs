...
namespace InstapropAPI.Migrations
{
    ...
    [Migration("20260824202632_EnableAllFeatureFlags")]
    partial class EnableAllFeatureFlags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstapropAPI.Models.Auction", b =>
                {
                    ...
                    b.Property<decimal?>("WinPreservingPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("InstapropAPI.Models.FeatureFlag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FeatureFlagId = new Guid("aa000001-0000-0000-0000-000000000001"),
                            Description = "Explore/Feed tab in bottom navigation",
                            FeatureKey = "FeedExplore",
                            IsEnabled = true,
                        ...
                        new
                        {
                            FeatureFlagId = new Guid("aa000001-0000-0000-0000-000000000005"),
                            Description = "News articles section (Phase 2)",
                            FeatureKey = "News",
                            IsEnabled = false,
                            LastUpdatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            FeatureFlagId = new Guid("aa000001-0000-0000-0000-000000000006"),
                            Description = "Developer live streaming (Phase 2)",
                        ...
                        new
                        {
                            FeatureFlagId = new Guid("aa000001-0000-0000-0000-000000000007"),
                            Description = "Floating AI Broker chat button (Phase 2)",
                            FeatureKey = "AIBroker",
                            IsEnabled = false,
                            LastUpdatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            FeatureFlagId = new Guid("aa000001-0000-0000-0000-000000000008"),
                            Description = "Weekly leaderboard and cashback prizes (Phase 2)",
                        ...
                        new
                        {
                            FeatureFlagId = new Guid("aa000001-0000-0000-0000-000000000009"),
                            Description = "Gold price vs property value comparison (Phase 2)",
                            FeatureKey = "GoldPriceComparison",
                            IsEnabled = false,
                            LastUpdatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
            ...
            modelBuilder.Entity("InstapropAPI.Models.Property", b =>
                {
                    b.Property<Guid>("PropertyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InstapropAPI.Models.Auction", b =>
                {
                    b.HasOne("InstapropAPI.Models.Property", "Property")
                        .WithMany("Auctions")
