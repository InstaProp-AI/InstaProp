...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropertyFlipperAPI.Models.InstallmentSummary", b =>
                {
            ...
            modelBuilder.Entity("PropertyFlipperAPI.Models.LeaderboardStanding", b =>
                {
            ...
            modelBuilder.Entity("PropertyFlipperAPI.Models.LiveStream", b =>
                {
            ...
            modelBuilder.Entity("PropertyFlipperAPI.Models.WeeklyLeaderboardSnapshot", b =>
                {
                    b.Property<long>("SnapshotId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PropertyFlipperAPI.Models.InstallmentSummary", b =>
                {
                    b.HasOne("PropertyFlipperAPI.Models.ChildProperty", "Property")
                        ...
                        .HasForeignKey("PropertyFlipperAPI.Models.InstallmentSummary", "PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PropertyFlipperAPI.Models.LeaderboardStanding", b =>
                {
                    ...
                    b.HasOne("PropertyFlipperAPI.Models.WeeklyLeaderboardSnapshot", "Snapshot")
                        .WithMany("Standings")
            ...
            modelBuilder.Entity("PropertyFlipperAPI.Models.WeeklyLeaderboardSnapshot", b =>
                {
                    b.HasOne("PropertyFlipperAPI.Models.Account", "SecondPlaceAccount")
                        .WithMany()
                        .HasForeignKey("SecondPlaceAccountId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PropertyFlipperAPI.Models.Account", "ThirdPlaceAccount")
                        .WithMany()
                        .HasForeignKey("ThirdPlaceAccountId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PropertyFlipperAPI.Models.Account", "WinnerAccount")
                        .WithMany()
